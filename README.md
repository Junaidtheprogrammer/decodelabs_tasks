...
|---|---|---|---|
| 1 | Atelier Form | Responsive HTML, CSS and JavaScript frontend | [Task 1](Task-1-Muhammad-Junaid/) |
| 2 | Synapse API | REST endpoints, validation and CRUD | [Task 2](Task-2-Muhammad-Junaid/) |
| 3 | Synapse Database | SQLite persistence, schema constraints and transactions | [Task 3](Task-3-Muhammad-Junaid/) |
...
- [Task 1](https://github.com/Junaidtheprogrammer/decodelabs_tasks/tree/main/Task-1-Muhammad-Junaid)
- [Task 2](https://github.com/Junaidtheprogrammer/decodelabs_tasks/tree/main/Task-2-Muhammad-Junaid)
- [Task 3](https://github.com/Junaidtheprogrammer/decodelabs_tasks/tree/main/Task-3-Muhammad-Junaid)
